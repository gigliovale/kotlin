...
public class Clone : IntrinsicMethod() {
    ...
    override fun toCallable(method: CallableMethod): IntrinsicCallable {
        return UnaryIntrinsic(method, AsmTypeConstants.OBJECT_TYPE) {
            if (isSuperCall) {
                it.invokespecial("java/lang/Object", "clone", "()Ljava/lang/Object;", false)
            }
            else {
                it.invokevirtual("java/lang/Object", "clone", "()Ljava/lang/Object;", false)
            }
        }
    }
}
