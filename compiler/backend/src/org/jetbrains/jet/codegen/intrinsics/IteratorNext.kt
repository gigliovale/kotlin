...
public class IteratorNext : IntrinsicMethod() {
    ...
    private fun iteratorName(returnType: Type): String {
        ...
        if (returnType == Type.CHAR_TYPE) {
            ...
            throw UnsupportedOperationException("Unkhown type " + returnType)
        }
        return name
    }
    ...
    override fun toCallable(method: CallableMethod): IntrinsicCallable {
        return MappedCallable(method) {
            method.invokeWithoutAssertions(it)
        }
    }
}
