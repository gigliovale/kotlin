...
public abstract class CodegenContext<T extends DeclarationDescriptor> {
    ...
    private static class AccessorKey {
        ...
        public int hashCode() {
            ...
            result = 31 * result + (superCallLabelTarget != null ? superCallLabelTarget.hashCode() : 0);
            return result;
        }
    ...
    @NotNull
    public PropertyDescriptor getPropertyAccessor(
            @NotNull PropertyDescriptor propertyDescriptor,
            @Nullable KtSuperExpression superCallExpression,
            boolean getterAccessorRequired,
            boolean setterAccessorRequired
    ) {
        return getAccessor(propertyDescriptor, false, null, superCallExpression, getterAccessorRequired, setterAccessorRequired);
    }
    ...
    public <D extends CallableMemberDescriptor> D getAccessor(
        ...
        return getAccessor(possiblySubstitutedDescriptor, isForBackingFieldInOuterClass, delegateType, superCallExpression,
