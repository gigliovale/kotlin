...
public class Usage {
    ...
    @NotNull
    public static String render(@NotNull CommonCompilerArguments arguments) {
        StringBuilder sb = new StringBuilder();
        appendln(sb, "Usage: " + arguments.executableScriptFileName() + " <options> <source files>");
    ...
    private static void fieldUsage(@NotNull StringBuilder sb, @NotNull Field field, boolean extraHelp) {
        ...
        sb.append(" ");
        appendln(sb, argument.description());
    }
