...
import org.jetbrains.kotlin.cli.common.jarvfs.impl.ArchiveHandler;
import org.jetbrains.kotlin.cli.common.jarvfs.impl.ZipHandler;
...
public class CoreJarHandler extends ZipHandler {
  ...
  private CoreJarVirtualFile getOrCreateFile(@NotNull EntryInfo info, @NotNull Map<EntryInfo, CoreJarVirtualFile> entries) {
    ...
    if (file == null) {
      FileAttributes attributes = new FileAttributes(info.isDirectory, false, false, false, info.length, ArchiveHandler.DEFAULT_TIMESTAMP, false);
