-injars '<output>/kotlin-compiler-client-embeddable-before-shrink.jar'(
...
-outjars '<kotlin-home>/lib/kotlin-compiler-client-embeddable.jar'
...
-dontwarn org.jetbrains.kotlin.cli.common.**
-dontwarn org.jetbrains.kotlin.daemon.client.CompilerCallbackServicesFacadeServer
-dontwarn org.jetbrains.kotlin.daemon.client.CompilationServices
-dontwarn org.jetbrains.kotlin.daemon.common.CompilerCallbackServicesFacade

-keep class org.jetbrains.kotlin.cli.common.messages.AnalyzerWithCompilerReport { *; }
