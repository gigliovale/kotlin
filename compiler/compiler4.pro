-injars '<output>/kotlin-compiler-before-shrink4.jar'(
...
-outjars '<kotlin-home>/lib/kotlin-compiler4.jar'
...
-dontwarn org.jetbrains.kotlin.serialization.MetadataSerializer
-dontwarn org.jetbrains.kotlin.cli.jvm.compiler.**
-dontwarn org.jetbrains.kotlin.load.kotlin.incremental.**
-dontwarn org.jetbrains.kotlin.modules.KotlinModuleXmlBuilder
-dontwarn org.jetbrains.kotlin.serialization.MetadataSerializer*
-dontwarn org.jetbrains.kotlin.load.kotlin.TypeSignatureMappingKt
-dontwarn org.jetbrains.kotlin.load.kotlin.PackageParts
-dontwarn org.jetbrains.kotlin.load.kotlin.ModuleMapping
-dontwarn org.jetbrains.kotlin.load.kotlin.MethodSignatureMappingKt
-dontwarn org.jetbrains.kotlin.load.kotlin.MemberSignature
-dontwarn org.jetbrains.kotlin.load.kotlin.JvmTypeFactoryImpl
-dontwarn org.jetbrains.kotlin.load.kotlin.JvmPackagePartSource
-dontwarn org.jetbrains.kotlin.load.kotlin.JvmNameResolver
-dontwarn org.jetbrains.kotlin.load.kotlin.JvmBuiltInsSettings*
-dontwarn org.jetbrains.kotlin.load.kotlin.JavaFlexibleTypeDeserializer
