...
class KtSecondaryConstructor : KtConstructor<KtSecondaryConstructor> {
    ...
    fun getDelegationCall(): KtConstructorDelegationCall? = findChildByClass(KtConstructorDelegationCall::class.java)
    ...
    fun replaceImplicitDelegationCallWithExplicit(isThis: Boolean): KtConstructorDelegationCall {
        ...
        return addAfter(psiFactory.createDelegatedSuperTypeEntry(delegationName + "()"), colon) as KtConstructorDelegationCall
    }
}
