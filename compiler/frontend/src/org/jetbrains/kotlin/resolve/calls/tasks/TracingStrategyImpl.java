...
public class TracingStrategyImpl extends AbstractTracingStrategy {
    private final KtReferenceElement reference;

    private TracingStrategyImpl(@NotNull KtReferenceElement reference, @NotNull Call call) {
        super(reference, call);
        this.reference = reference;
    }

    @NotNull
    public static TracingStrategy create(@NotNull KtReferenceElement reference, @NotNull Call call) {
