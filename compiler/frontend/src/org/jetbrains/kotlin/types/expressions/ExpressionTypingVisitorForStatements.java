...
public class ExpressionTypingVisitorForStatements extends ExpressionTypingVisitor {
    ...
    @Override
    public TypeInfoWithJumpInfo visitObjectDeclaration(@NotNull JetObjectDeclaration declaration, ExpressionTypingContext context) {
        ...
        return TypeInfoFactory.Companion.createTypeInfo(DataFlowUtils.checkStatementType(declaration, context), context);
    }

    @Override
    public TypeInfoWithJumpInfo visitProperty(@NotNull JetProperty property, ExpressionTypingContext typingContext) {
    ...
    @Override
    public TypeInfoWithJumpInfo visitMultiDeclaration(@NotNull JetMultiDeclaration multiDeclaration, ExpressionTypingContext context) {
        ...
        TypeInfoWithJumpInfo typeInfo = facade.getTypeInfo(initializer, context);
    ...
    @Override
    public TypeInfoWithJumpInfo visitNamedFunction(@NotNull JetNamedFunction function, ExpressionTypingContext context) {
        return functions.visitNamedFunction(function, context, true, scope);
    }

    @Override
    public TypeInfoWithJumpInfo visitClass(@NotNull JetClass klass, ExpressionTypingContext context) {
        components.localClassifierAnalyzer.processClassOrObject(
                components.globalContext,
                scope, context.replaceScope(scope).replaceContextDependency(INDEPENDENT), scope.getContainingDeclaration(), klass,
                components.additionalCheckerProvider,
                components.dynamicTypesSettings);
        return TypeInfoFactory.Companion.createTypeInfo(DataFlowUtils.checkStatementType(klass, context), context);
    }

    @Override
    public TypeInfoWithJumpInfo visitTypedef(@NotNull JetTypedef typedef, ExpressionTypingContext context) {
    ...
    public TypeInfoWithJumpInfo visitDeclaration(@NotNull JetDeclaration dcl, ExpressionTypingContext context) {
        return TypeInfoFactory.Companion.createTypeInfo(DataFlowUtils.checkStatementType(dcl, context), context);
    }

    @Override
    public TypeInfoWithJumpInfo visitBinaryExpression(@NotNull JetBinaryExpression expression, ExpressionTypingContext context) {
    ...
    @NotNull
    protected TypeInfoWithJumpInfo visitAssignmentOperation(JetBinaryExpression expression, ExpressionTypingContext contextWithExpectedType) {
        ...
        TypeInfoWithJumpInfo leftInfo = ExpressionTypingUtils.getTypeInfoOrNullType(leftOperand, context, facade);
        ...
        if (leftType == null) {
            TypeInfoWithJumpInfo rightInfo = facade.getTypeInfo(right, context.replaceDataFlowInfo(leftInfo.getDataFlowInfo()));
        ...
        TypeInfoWithJumpInfo rightInfo = leftInfo;
    ...
    @NotNull
    protected TypeInfoWithJumpInfo visitAssignment(JetBinaryExpression expression, ExpressionTypingContext contextWithExpectedType) {
        ...
        if (left instanceof JetArrayAccessExpression) {
            ...
            if (right == null) return TypeInfoFactory.Companion.createTypeInfo(context);
            TypeInfoWithJumpInfo typeInfo = basic.resolveArrayAccessSetMethod(arrayAccessExpression, right, context, context.trace);
        ...
        TypeInfoWithJumpInfo leftInfo = ExpressionTypingUtils.getTypeInfoOrNullType(left, context, facade);
        JetType leftType = leftInfo.getType();
        DataFlowInfo dataFlowInfo = leftInfo.getDataFlowInfo();
        TypeInfoWithJumpInfo rightInfo;
        if (right != null) {
    ...
    @Override
    public TypeInfoWithJumpInfo visitExpression(@NotNull JetExpression expression, ExpressionTypingContext context) {
        return facade.getTypeInfo(expression, context);
    }
    ...
    @Override
    public TypeInfoWithJumpInfo visitWhileExpression(@NotNull JetWhileExpression expression, ExpressionTypingContext context) {
        return controlStructures.visitWhileExpression(expression, context, true);
    }

    @Override
    public TypeInfoWithJumpInfo visitDoWhileExpression(@NotNull JetDoWhileExpression expression, ExpressionTypingContext context) {
        return controlStructures.visitDoWhileExpression(expression, context, true);
    }

    @Override
    public TypeInfoWithJumpInfo visitForExpression(@NotNull JetForExpression expression, ExpressionTypingContext context) {
        return controlStructures.visitForExpression(expression, context, true);
    }

    @Override
    public TypeInfoWithJumpInfo visitAnnotatedExpression(
    ...
    @Override
    public TypeInfoWithJumpInfo visitIfExpression(@NotNull JetIfExpression expression, ExpressionTypingContext context) {
        return controlStructures.visitIfExpression(expression, context, true);
    }

    @Override
    public TypeInfoWithJumpInfo visitWhenExpression(@NotNull JetWhenExpression expression, ExpressionTypingContext context) {
    ...
    @Override
    public TypeInfoWithJumpInfo visitLabeledExpression(@NotNull JetLabeledExpression expression, ExpressionTypingContext context) {
