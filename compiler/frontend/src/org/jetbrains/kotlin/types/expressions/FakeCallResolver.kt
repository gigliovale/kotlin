...
public class FakeCallResolver(
    ...
    public fun resolveFakeCall(
        ...
        val fakeArguments = Lists.newArrayList<JetExpression>()
        ...
        return makeAndResolveFakeCall(receiver, context.replaceBindingTrace(traceWithFakeArgumentInfo), fakeArguments, name, callElement).getSecond()
    }
    ...
    public fun resolveFakeCall(
        ...
        return resolveFakeCall(receiver, context, emptyList<JetExpression>(), name, callElement)
    }
    ...
    public fun makeAndResolveFakeCall(
        ...
        if (results.isSuccess()) {
            fakeTrace.commit(object : TraceEntryFilter {
        ...
        return Pair.create<Call, OverloadResolutionResults<FunctionDescriptor>>(call, results)
    }
