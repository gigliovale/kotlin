...
public class ValueParameterResolver(
    ...
    public fun resolveValueParameters(valueParameters: List<JetParameter>, valueParameterDescriptors: List<ValueParameterDescriptor>, context: ExpressionTypingContext) {
        for (i in valueParameters.indices) {
            val valueParameterDescriptor = valueParameterDescriptors.get(i)
            val jetParameter = valueParameters.get(i)
    ...
    private fun resolveDefaultValue(
        ...
        if (valueParameterDescriptor.hasDefaultValue()) {
            val defaultValue = jetParameter.getDefaultValue()
