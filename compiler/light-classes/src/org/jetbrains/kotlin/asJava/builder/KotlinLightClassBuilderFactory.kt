...
class KotlinLightClassBuilderFactory(private val javaFileStub: PsiJavaFileStub) : ClassBuilderFactory {
    ...
    override fun asText(builder: ClassBuilder) = throw UnsupportedOperationException("asText is not implemented") // TODO
    override fun asBytes(builder: ClassBuilder) = throw UnsupportedOperationException("asBytes is not implemented") // TODO
    override fun close() {}
