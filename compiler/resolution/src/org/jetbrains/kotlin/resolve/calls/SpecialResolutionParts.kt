...
object CheckInfixResolutionPart : ResolutionPart {
    override fun SimpleResolutionCandidate.process(): List<CallDiagnostic> {
        if (astCall.isInfixCall && (candidateDescriptor !is FunctionDescriptor || !candidateDescriptor.isInfix)) {
...
object CheckOperatorResolutionPart : ResolutionPart {
    override fun SimpleResolutionCandidate.process(): List<CallDiagnostic> {
        if (astCall.isOperatorCall && (candidateDescriptor !is FunctionDescriptor || !candidateDescriptor.isOperator)) {
