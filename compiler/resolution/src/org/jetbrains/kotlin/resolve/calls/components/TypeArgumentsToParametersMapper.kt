...
class TypeArgumentsToParametersMapper {
    ...
    sealed class TypeArgumentsMapping(val diagnostics: List<CallDiagnostic>) {
    ...
    fun mapTypeArguments(call: ASTCall, descriptor: CallableDescriptor): TypeArgumentsMapping {
