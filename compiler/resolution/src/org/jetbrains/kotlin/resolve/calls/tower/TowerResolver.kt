...
class TowerResolver {
    ...
    class SuccessfulResultCollector<C>(getStatus: (C) -> ResolutionCandidateStatus): ResultCollector<C>(getStatus) {
        ...
        fun getResolved() = currentCandidates.keepIf { currentLevel == ResolutionCandidateApplicability.RESOLVED }

        fun getResolvedLowPriority() = currentCandidates.keepIf { currentLevel == ResolutionCandidateApplicability.RESOLVED_LOW_PRIORITY }

        fun getErrors() = currentCandidates.keepIf {
