...
public class BlackBoxWithJavaCodegenTestGenerated extends AbstractBlackBoxCodegenTest {
    ...
    @TestMetadata("compiler/testData/codegen/boxWithJava/JvmClassName")
    @TestDataPath("$PROJECT_ROOT")
    @RunWith(JUnit3RunnerWithInners.class)
    public static class JvmClassName extends AbstractBlackBoxCodegenTest {
        public void testAllFilesPresentInJvmClassName() throws Exception {
            JetTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("compiler/testData/codegen/boxWithJava/JvmClassName"), Pattern.compile("^([^\\.]+)$"), true);
        }

        @TestMetadata("simple")
        public void testSimple() throws Exception {
            String fileName = JetTestUtils.navigationMetadata("compiler/testData/codegen/boxWithJava/JvmClassName/simple/");
            doTestWithJava(fileName);
        }
