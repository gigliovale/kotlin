...
public class IrTextTestCaseGenerated extends AbstractIrTextTestCase {
    ...
    public static class Expressions extends AbstractIrTextTestCase {
        ...
        @TestMetadata("outerThisReference1.kt")
        public void testOuterThisReference1() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/ir/irText/expressions/outerThisReference1.kt");
            doTest(fileName);
        }

        @TestMetadata("outerThisReference2.kt")
        public void testOuterThisReference2() throws Exception {
            String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/ir/irText/expressions/outerThisReference2.kt");
            doTest(fileName);
        }
