...
public abstract class LazyJavaMemberScope<T: DeclarationDescriptor>(
        protected val c: LazyJavaResolverContextWithTypes,
        protected val _containingDeclaration: T
) : JetScope {
    ...
    protected abstract fun getMethodSignatureData(method: JavaMethod, methodTypeParameters: List<TypeParameterDescriptor>,
    ...
    internal fun resolveMethodToFunctionDescriptor(method: JavaMethod, record: Boolean = true): SimpleFunctionDescriptor {
        ...
        val (effectiveSignature, superFunctions, signatureErrors) = getMethodSignatureData(method, methodTypeParameters, returnType, valueParameters)
