...
enum class SourceKind { NONE, PRODUCTION, TEST }
...
class PlatformHeaderAnnotator : Annotator {
    ...
    override fun annotate(element: PsiElement, holder: AnnotationHolder) {
        ...
        val dependentDescriptors = defaultModuleDescriptor.allImplementingModules.filter {
            it.sourceKind == defaultModuleDescriptor.sourceKind
        }
