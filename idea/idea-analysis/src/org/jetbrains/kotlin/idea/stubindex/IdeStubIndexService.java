...
public class IdeStubIndexService extends StubIndexService {
    ...
    public void indexFile(KotlinFileStub stub, IndexSink sink) {
        ...
        if (facadeFqName != null) {
            sink.occurrence(JetFileFacadeFqnIndex.INSTANCE.getKey(), facadeFqName.asString());
        ...
        if (jetFile != null) {
            ...
            sink.occurrence(JetFileFacadeFqnIndex.INSTANCE.getKey(), fileClassInfo.getFacadeClassFqName().asString());
