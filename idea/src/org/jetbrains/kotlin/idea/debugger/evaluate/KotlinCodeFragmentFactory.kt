...
class KotlinCodeFragmentFactory: CodeFragmentFactory() {
    ...
    companion object {
        ...
        private fun KtElement?.check(): Boolean = this != null && this.keepIf { KotlinEditorTextProvider.isAcceptedAsCodeFragmentContext(it) } != null
    ...
    private fun createFakeFileWithJavaContextElement(funWithLocalVariables: String, javaContext: PsiElement): KtFile {
        ...
        javaFile?.packageName?.keepIf { !it.isBlank() }?.let {
