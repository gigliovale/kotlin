...
class KotlinCodeFragmentFactory: CodeFragmentFactory() {
    ...
    companion object {
        ...
        private fun KtElement?.check(): Boolean = this != null && this.ensureOrNull { KotlinEditorTextProvider.isAcceptedAsCodeFragmentContext(it) } != null
    ...
    private fun createFakeFileWithJavaContextElement(funWithLocalVariables: String, javaContext: PsiElement): KtFile {
        ...
        javaFile?.packageName?.ensureOrNull { !it.isBlank() }?.let {
