...
class KotlinCodeFragmentFactory: CodeFragmentFactory() {
    ...
    companion object {
        ...
        private fun KtElement?.check(): Boolean = this != null && this.passIf { KotlinEditorTextProvider.isAcceptedAsCodeFragmentContext(it) } != null
    ...
    private fun createFakeFileWithJavaContextElement(funWithLocalVariables: String, javaContext: PsiElement): KtFile {
        ...
        javaFile?.packageName?.passIf { !it.isBlank() }?.let {
