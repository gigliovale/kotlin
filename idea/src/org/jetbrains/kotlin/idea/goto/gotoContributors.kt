...
class KotlinGotoClassContributor : GotoClassContributor {
    ...
    override fun getItemsByName(name: String, pattern: String, project: Project, includeNonProjectItems: Boolean): Array<NavigationItem> {
        ...
        val filteredScope = KotlinSourceFilterScope.sourceAndClassFiles(baseScope, project)
        val classesOrObjects = KotlinClassShortNameIndex.getInstance().get(name, project, filteredScope)
        val typeAliases = KotlinTypeAliasShortNameIndex.getInstance().get(name, project, filteredScope)
        ...
        classesOrObjects.filterTo(result) { it != null && it !is KtEnumEntry }
