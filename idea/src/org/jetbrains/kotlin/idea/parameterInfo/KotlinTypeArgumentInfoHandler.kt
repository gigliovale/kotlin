...
class KotlinClassTypeArgumentInfoHandler : KotlinTypeArgumentInfoHandlerBase<ClassDescriptor>() {
    ...
    override fun findParameterOwners(context: CreateParameterInfoContext, argumentList: KtTypeArgumentList): Collection<ClassDescriptor>? {
...
class KotlinFunctionTypeArgumentInfoHandler : KotlinTypeArgumentInfoHandlerBase<FunctionDescriptor>() {
    ...
    override fun findParameterOwners(context: CreateParameterInfoContext, argumentList: KtTypeArgumentList): Collection<FunctionDescriptor>? {
...
abstract class KotlinTypeArgumentInfoHandlerBase<TParameterOwner : DeclarationDescriptor> : ParameterInfoHandlerWithTabActionSupport<KtTypeArgumentList, TParameterOwner, KtTypeProjection> {
    ...
    protected abstract fun findParameterOwners(context: CreateParameterInfoContext, argumentList: KtTypeArgumentList): Collection<TParameterOwner>?
    ...
    override fun findElementForUpdatingParameterInfo(context: UpdateParameterInfoContext): KtTypeArgumentList? {
        ...
        val argumentList = PsiTreeUtil.getParentOfType(element, argumentListClass) ?: return null
    ...
    override fun findElementForParameterInfo(context: CreateParameterInfoContext): KtTypeArgumentList? {
        ...
        val argumentList = PsiTreeUtil.getParentOfType(token, argumentListClass) ?: return null

        val parameterOwners = findParameterOwners(context, argumentList) ?: return null
    ...
    private fun updateUIOrFail(itemToShow: TParameterOwner, context: ParameterInfoUIContext): Boolean {
        ...
        context.setupUIComponentPresentation(text, currentParameterStart, currentParameterEnd, false, false, false, context.defaultParameterColor)
