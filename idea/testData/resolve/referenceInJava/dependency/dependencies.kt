...
public class Class() {
    ...
    fun <T : Number, G> function2(
            ...
            ba: ByteArray, ca: CharArray, ia: IntArray, la: LongArray, boola: BooleanArray, fa: FloatArray, da: DoubleArray,
            t: T, g: G, str: String, nestedClass: Class.F, innerClass: Class.G
    ) {
    }
