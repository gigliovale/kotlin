...
public abstract class KotlinDebuggerTestCase extends DescriptorTestCase {
    ...
    @SuppressWarnings("FieldMayBeFinal") private static boolean LOCAL_CACHE_REUSE = false;
    ...
    private static void overrideTempOutputDirectory() {
        try {
            ...
            if (!LOCAL_CACHE_DIR.exists()) {
                ...
                Assert.assertTrue("Failed while creating directories for local cache", result);
            }
