...
public class QuickFixTestGenerated extends AbstractQuickFixTest {
    ...
    public static class DeprecatedSymbolUsage extends AbstractQuickFixTest {
        ...
        @TestMetadata("idea/testData/quickfix/deprecatedSymbolUsage/typeAlias")
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class TypeAlias extends AbstractQuickFixTest {
            public void testAllFilesPresentInTypeAlias() throws Exception {
                KotlinTestUtils.assertAllTestsPresentByMetadata(this.getClass(), new File("idea/testData/quickfix/deprecatedSymbolUsage/typeAlias"), Pattern.compile("^([\\w\\-_]+)\\.kt$"), TargetBackend.ANY, true);
            }

            @TestMetadata("simple.kt")
            public void testSimple() throws Exception {
                String fileName = KotlinTestUtils.navigationMetadata("idea/testData/quickfix/deprecatedSymbolUsage/typeAlias/simple.kt");
                doTest(fileName);
            }
        }
