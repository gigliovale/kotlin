...
class JpsKotlinFacetModuleExtension(val settings: KotlinFacetSettings) : JpsElementBase<JpsKotlinFacetModuleExtension>() {
    companion object {
    ...
    override fun createCopy(): JpsKotlinFacetModuleExtension {
