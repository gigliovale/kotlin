...
public final class ExpressionVisitor extends TranslatorVisitor<JsNode> {
    ...
    public JsNode visitReturnExpression(@NotNull KtReturnExpression jetReturnExpression, @NotNull TranslationContext context) {
        ...
        if (returned == null) {
            ...
            assert context.getDeclarationDescriptor() != null;
            if (MetadataProperties.isUnboxedChar(jsReturnExpression) &&
                !JsDescriptorUtils.callGivesUnboxedChar((CallableDescriptor) context.getDeclarationDescriptor())
            ) {
