 ...
 */
public fun <T> Iterable<T>.slidingWindow(size: Int, step: Int = size.coerceAtLeast(1), dropTrailing: Boolean = false): Sequence<List<T>> {
 ...
 * @return a sequence of windows, possibly empty
 */
public fun <T> List<T>.slidingWindow(size: Int, step: Int = size.coerceAtLeast(1), dropTrailing: Boolean = false): Sequence<List<T>> {
    require(step > 0) { "step should be positive but it is $step" }
 ...
 * @return a sequence of windows, possibly empty
 */
public fun <T> List<T>.slidingWindowBackward(size: Int, step: Int = size.coerceAtLeast(1), dropTrailing: Boolean = false): Sequence<List<T>> {
    require(step > 0) { "step should be positive but it is $step" }
    return windowIndices(this.size, size, -step, dropTrailing).map { subList(it.start, it.endInclusive + 1) }
}
