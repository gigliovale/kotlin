...
private fun addConstructorParameter(
    ...
    constructor.getValueParameterList()!!.addParameter(parameter).apply { reformat(this) }
}
...
private fun findProperConstructorAndAddParameter(
    ...
    val constructorOrigin = lightConstructor.getOrigin()
    ...
    try {
        ...
        for ((i, psiParam) in dummyMethod.parameterList.parameters.withIndex()) {
            ...
            val ktParameter = psiFactory.createParameter(
                    "${psiParam.name}: ${IdeDescriptorRenderers.SOURCE_CODE_FOR_TYPE_ARGUMENTS.renderType(descriptor.type)}"
            )
